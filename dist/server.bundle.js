...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RESEARCH_EVENTS = exports.DELETE_EVENT = exports.ADD_EVENTS = exports.ADD_EVENT = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _passportLocal = __webpack_require__(75);
	
	var _passportJwt = __webpack_require__(74);
	...
	var localCallback = function localCallback(req, username, pass, done) {
	...
	var jwtCallback = function jwtCallback(payload, done) {
	    var cuid = payload.sub;
	...
	var localStrategy = new _passportLocal.Strategy(localOptions, localCallback);
	
	var jwtStrategy = new _passportJwt.Strategy(jwtOptions, jwtCallback);
	
	var jwtSessionStrategy = new _passportJwt.Strategy(jwtSessionOptions, jwtCallback);
	
	_passport2.default.use('local', localStrategy);
	_passport2.default.use('jwt', jwtStrategy);
	_passport2.default.use('jwt-session', jwtSessionStrategy);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventResearch = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostList = __webpack_require__(53);
	
	var _PostList2 = _interopRequireDefault(_PostList);
	
	var _PostCreateWidget = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventSchema = new Schema({ name: { type: 'String', required: true },
	  picture: { type: 'String' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bcryptNodejs = __webpack_require__(62);
	...
	userSchema.methods.hashPassword = function (password) {
	  _bcryptNodejs2.default.hashSync(password, _bcryptNodejs2.default.genSalt(8), null);
	};
	
	userSchema.methods.checkPassword = function (password) {
	  return _bcryptNodejs2.default.compareSync(password, undefined.password);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DevTools = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		/*User.count().exec((err, count) => {
	 	...
	 	newUser.password = newUser.hashPassword('test');
	...
	var jsonEvents = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authentification = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventResearch = exports.EventResearch = function (_Component) {
	  ...
	  _createClass(EventResearch, [{
	    ...
	    key: 'render',
	    value: function render() {
	      return _jsx('div', {}, void 0, _jsx('form', {}, void 0, _jsx('p', {}, void 0, _ref, _react2.default.createElement('input', { type: 'text', name: 'inputResearch', ref: 'research' }), _jsx('button', {
	        onClick: this.ClickClack,
	        value: 'test'
	      }, void 0, 'Envoyer'), _jsx('input', {
	        type: 'radio',
	        id: 'researchChoice1',
	        name: 'choice',
	        value: 'ourDB',
	        onChange: this.handleOptionChange,
	        checked: this.state.selectedOption === 'ourDB'
	      }), _ref2, _jsx('input', {
	        type: 'radio',
	        id: 'researchChoice2',
	        name: 'choice',
	        value: 'facebookDB',
	        onChange: this.handleOptionChange,
	        checked: this.state.selectedOption === 'facebookDB'
	      }), _ref3, _jsx('input', {
	        type: 'range',
	        id: 'distanceKM',
	        min: '1',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostListItem = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IntlReducer = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonwebtoken = __webpack_require__(71);
	...
	function login(req, res) {
	    _passport2.default.authenticate('local', { session: false }, function (err, user, info) {
	        ...
	        if (!user) {
	            ...
	            var payload = { usnername: user.usnername };
	            var options = { subject: user.cuid };
	            var token = _jsonwebtoken2.default.sign(payload, 'secret', options);
	
	            req.session.token = token;
	
	            return res.json({ message: '', user: { ok: true, token: token } });
	        }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _elasticsearch = __webpack_require__(64);
	
	var _elasticsearch2 = _interopRequireDefault(_elasticsearch);
	
	var _facebookEventsByLocationCore = __webpack_require__(65);
	...
	var accessToken = "https://graph.facebook.com/endpoint?key=value&access_token=1506957062727502|77a270d081b143d06581ac7dc05424b4";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cookieParser = __webpack_require__(39);
	
	var _cookieParser2 = _interopRequireDefault(_cookieParser);
	
	var _expressSession = __webpack_require__(40);
	...
	var _authentification = __webpack_require__(32);
	...
	var _dummyDataEvent = __webpack_require__(31);
	
	var _dummyDataEvent2 = _interopRequireDefault(_dummyDataEvent);
