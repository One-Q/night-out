...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventReducer = __webpack_require__(18);
	    ...
	    value: function render() {
	      ...
	      if (this.props.events !== undefined) {
	        events = this.props.events.map(function (event) {
	          ...
	          }, event._id, _jsx('h2', {}, void 0, event.name), _jsx('p', {}, void 0, event.description), _jsx('p', {}, void 0, event.location.city, ', ', event.location.street));
	        });
	      }
	      return _jsx('div', {}, void 0, _ref, events);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DELETE_EVENT = exports.ADD_EVENTS = exports.ADD_EVENT = undefined;
	...
	// Export Constants
	var ADD_EVENT = exports.ADD_EVENT = 'ADD_EVENTS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostList = __webpack_require__(47);
	
	var _PostList2 = _interopRequireDefault(_PostList);
	
	var _PostCreateWidget = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		_event2.default.count().exec(function (err, count) {
			...
			var event1 = new _event2.default({
				name: "Cours de Yoga",
				picture: 'None',
			...
			var event3 = new _event2.default({
			...
			var event4 = new _event2.default({
			...
			var event5 = new _event2.default({
			...
			var event6 = new _event2.default({
			...
			var event7 = new _event2.default({
			...
			var event8 = new _event2.default({
			...
			var event9 = new _event2.default({
			...
			var event10 = new _event2.default({
			...
			_event2.default.create([event1, event2, event3, event4, event5, event6, event7, event8, event9, event10], function (error) {
				if (!error) {
					// console.log('ready to go....');
				}
			});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostListItem = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getEvent(req, res) {
	  _event2.default.findOne({ slug: req.params.name }).exec(function (err, event) {
	    if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dummyDataEvent = __webpack_require__(29);
